...
/* Implementations */
    ...
    inline std::string join(const std::vector <std::string> &subs,
    ...
    template<template<typename...> class Container, typename T>
    inline std::string join(const Container<T> &subs, const char delim) {
        return join(subs, std::string{delim});
    }

    template<template<typename...> class Container, typename T>
    inline std::string join(const Container<T> &subs, const std::string &delim) {
    ...
    inline bool starts_with(const std::string &s, const std::string &start) {
